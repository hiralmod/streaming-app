    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex items-center">
                ...
                <div class="relative">
                    <input type="text" class="bg-gray-800 rounded-full w-64 px-4 pl-14 py-2 focus:outline-none focus:shadow-outline" placeholder="Serach">
                    <div class="absolute top-2 pl-6">
                        <i class="fa-solid fa-magnifying-glass text-gray-500 w-1"></i>
                    </div>
                </div>
                <a href="#">
